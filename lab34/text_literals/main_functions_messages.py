...
CITY_ADDED_MESSAGE = 'city was successfully added'
CITY_DELETED_MESSAGE = 'city was successfully deleted'
...
ALERT_MESSAGE = "you'll recieve notification about weather in"
